...
def ERA5_data_downloader():
    file_ERA_path = DATA_DIR / ERA5_FILE
    ...
    if file_ERA_path.exists():
        ...
        client.retrieve(dataset, request).download(str(DATA_DIR / "ERA5_data.zip")) 
...
def Load_slice_conv_dataset(lat_min, lat_max, lon_min, lon_max):
    ...
    file_ERA_path = DATA_DIR / ERA5_FILE
    file_CSR_path = DATA_DIR / GRACE_CSR_FILE
...
if __name__ == "__main__":
    ...
    df_ERA, df_CSR = Load_slice_conv_dataset(lat_min, lat_max, lon_min, lon_max)
